...
class SutdaDeck {
	...
	SutdaCard4[] cards = new SutdaCard4[CARD_NUM];
	...
	SutdaDeck() {
		for (int i = 0; i < cards.length; i++) {
			...
			cards[i] = new SutdaCard4(num, isKwang);
		}
	...
	SutdaCard4 pick() throws Exception {
		SutdaCard4 c = null;
...
class Player {
	...
	Player(String name, SutdaCard4 c1, SutdaCard4 c2) {
		this.name = name;
		this.c1 = c1;
		this.c2 = c2;
	}
